#ifndef PROG2002_SHADERDATATYPE_H
#define PROG2002_SHADERDATATYPE_H
...
{
    if (type == ShaderDataType::Float  || type == ShaderDataType::Float2 ||
...
#endif //PROG2002_SHADERDATATYPE_H
